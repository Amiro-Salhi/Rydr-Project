...
<main class="car-detail">
    <div class="grid">
        ...
        <div class="row white-background">
            ...
            <p>NISMO is het toonbeeld geworden van Volkswagen's uitzonderlijke prestaties, geïnspireerd door het meest meedogenloze testterrein: het circuit.</p>
            <div class="car-type">
                <div class="grid">
                    <div class="row"><span class="accent-color">Type Car</span><span>SUV</span></div>
                    <div class="row"><span class="accent-color">Capacity</span><span>7 person</span></div>
                </div>
                <div class="grid">
                    <div class="row"><span class="accent-color">Steering</span><span>Manual</span></div>
                    <div class="row"><span class="accent-color">Gasoline</span><span>58L</span></div>
                </div>
                <div class="call-to-action">
                    <div class="row"><span class="font-weight-bold">€100,00</span> / dag</div>
